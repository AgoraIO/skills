...
- CLI below `0.2.2`, or config schema newer than the running binary: follow the
  curl-first upgrade path in [install-auth.md](install-auth.md#version-gate-and-upgrade)
